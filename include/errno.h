...
/*
 * These are largely generated from errno -l
 * on my system then converting some constants so
...
#define EWOULDBLOCK 41 /* Resource temporarily unavailable */
...
#define EDEADLOCK 58 /* Resource deadlock avoided */
